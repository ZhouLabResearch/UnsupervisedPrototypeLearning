function net = resnet_custom(inputSize, numClasses, options)
...
%     fullyConnectedLayer(2,'Name','fc','WeightsInitializer', iDefaultWeightsInitializer()),...
%     customRegressionLayer('mae') ];
% end
%%% prototype
%%% normal
function net = iFinalLayers(numClasses)
